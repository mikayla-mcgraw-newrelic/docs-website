...
import supportNav from 'images/support-nav.png'

import inProductSupport from 'images/in-product-support.png'

import newRelicExplorersHub from 'images/new-relic-explorers-hub.png'

import docsFeedbackImg from 'images/docs_feedback.png';
...
All [in-product support](https://one.newrelic.com/redirect/support) resources are accessible while navigating our platform: Just select the small **?** icon from the top right navigation menu.

<img
  title="Support navigation"
  alt="Support navigation"
  src={supportNav}
/>
...
<img
  title="New Relic's Explorer Hub"
  alt="New Relic's Explorer Hub"
  src={newRelicExplorersHub}
/>

<figcaption>
  [**discuss.newrelic.com**](https://discuss.newrelic.com/): The Explorer Hub is
  our public forum. Use it to ask questions and find answers. Join our community
  of users to learn more about New Relic and get some inspiration.
</figcaption>
...
1. Go to the **[Create a Support Case](https://one.newrelic.com/redirect/support)** button **Looking for more help?** on bottom footer.
