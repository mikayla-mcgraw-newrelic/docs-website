...
1. Go to the <DNT>**[Create a Support Case](https://one.newrelic.com/redirect/support)**</DNT> button in the bottom footer of the support home page.
...
3. Click <DNT>**Create a Support case**</DNT>.
